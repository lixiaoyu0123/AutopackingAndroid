...
const QString WEB_SITE = "https://git.oschina.net/bingjian/AutopackingAndroid/CurrentVersion";
...
ui(new Ui::About)
{
	...
	QString credits = "<h4>" + QStringLiteral("作者") + "</h4>" +
	"<ul><li>"+ QStringLiteral("冰剑") + "</li></ul>" +
		"<h4>" + QStringLiteral("联系方式") + "</h4>" +
		"<ul>" +
		"<li>QQ:21314601</li>" +

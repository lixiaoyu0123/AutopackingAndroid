            ...
            if (control_char.isNull()) {
                ...
                if (c.isDigit()) {
                    ...
                    if (backref_number >= 0 && backref_number < capture_groups_offsets.count()) {
						accumulateReplcementText(text.mid(capture_groups_offsets.at(backref_number).first, capture_groups_offsets.at(backref_number).second - capture_groups_offsets.at(backref_number).first));
                    } else {

...
public:
	...
	static bool ReplaceStr(QString &fileName, QString &srcStr, QString &replaceStr,QString &encode);
	static int ReplaceStrStrict(QString &fileName, QString &srcStr, QString &replaceStr, QString &encode);
	...
	static bool ReplacePakNameInJava(QString &srcPath, QString &fileName, QString &oldName, QString &newName, QString &encode);
	static bool ReplaceAppPakNameInJava(QString &srcPath, QString &fileName, QString &oldName, QString &newName, QString &encode);
	...
	static int ReplacePakInSrc(QString &path, QString &oldName, QString &newName,QString &encode);
	static int ReplacePakInDec(QString &path, QString &oldName, QString &newName);
	static int ReplaceAppPakInSrc(QString &path, QString &oldName, QString &newName,QString &encode);
	...
	static void SetEncode(int code);
	static int GetEncode();
	static QString GetEncodeToStr();
protected:
private:

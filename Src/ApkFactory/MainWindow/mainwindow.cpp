...
{
	BjMessageBox::warning(this, QStringLiteral("检查更新"), QStringLiteral("由于目前没有资金建立检测更新服务器，所以自动更新功能暂时不能使用。\n希望能得到您的支持来帮助完成自动更新服务器的建设。下面是开发者的支付宝，希望您能支持。感谢！\n支付宝：21314601@qq.com 验证姓名：李晓宇！"), QMessageBox::Ok, QMessageBox::NoButton);
}
